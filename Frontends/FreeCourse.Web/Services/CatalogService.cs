...
namespace FreeCourse.Web.Services
{
    public class CatalogService : ICatalogService
    {
        ...
        {
            var response = await _httpClient.GetAsync("categories");//catalog api controller adı
        ...
        {
            var response = await _httpClient.GetAsync("courses");//catalog api controller adı
            if (!response.IsSuccessStatusCode)
            {
                return null;
            }
